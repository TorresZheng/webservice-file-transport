 ...
 * generated in the com.zyyfw package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://zyyfw.com/", "download");
    private final static QName _Upload_QNAME = new QName("http://zyyfw.com/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://zyyfw.com/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://zyyfw.com/", "uploadResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zyyfw
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zyyfw.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zyyfw.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zyyfw.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zyyfw.com/", name = "uploadResponse")
